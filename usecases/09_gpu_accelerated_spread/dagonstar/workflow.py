"""Dagonstar workflow sketch for the 09 Gpu Accelerated Spread use case."""
...
def build_workflow(task):
    ...
    t1 = task("step_01", "python usecases/09_gpu_accelerated_spread/demo/step_01_run_gpu_spread.py")
