"""Dagonstar workflow sketch for the 07 Wildfire Fire And Smoke use case."""
...
def build_workflow(task):
    ...
    t1 = task("step_01", "python usecases/07_wildfire_fire_and_smoke/demo/step_01_run_fire_spread.py")
    t2 = task("step_02", "python usecases/07_wildfire_fire_and_smoke/demo/step_02_run_smoke.py")
    t1 >> t2
