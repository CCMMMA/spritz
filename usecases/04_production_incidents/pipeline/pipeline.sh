...
DX="${DX:-100}"
DY="${DY:-100}"
EMISSION_RATE_G_S="${EMISSION_RATE_G_S:-20.0}"
WIND_SPEED_M_S="${WIND_SPEED_M_S:-3.0}"
SOURCE_X_M="${SOURCE_X_M:-1000.0}"
SOURCE_Y_M="${SOURCE_Y_M:-1000.0}"
CONFIG_PATH="${OUT_DIR}/production_incident_config.json"
