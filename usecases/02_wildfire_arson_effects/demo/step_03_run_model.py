...
from plotting import add_plot_argument, plot_3d_volume_if_available, plot_concentration_vertical_profiles_if_available
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.plot:
        ...
        if plots:
            ...
            LOGGER.info("step 3/3 plotting: no figures were generated")
    else:
        LOGGER.info("step 3/3 plotting: skipped; pass --plot to generate maps, profiles, and 3-D renders")
