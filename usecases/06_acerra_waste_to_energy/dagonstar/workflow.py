"""Dagonstar workflow sketch for the 06 Acerra Waste To Energy use case."""
...
def build_workflow(task):
    ...
    t1 = task("step_01", "python usecases/06_acerra_waste_to_energy/demo/step_01_build_config.py")
    t2 = task("step_02", "python usecases/06_acerra_waste_to_energy/demo/step_02_run_model.py")
    t1 >> t2
