...
REQUIRED = [
    ...
    "docs/terrain.md",
    "usecases/README.md",
    "usecases/01_high_resolution_wind_field/demo/README.md",
    "usecases/02_wildfire_arson_effects/demo/README.md",
    "usecases/03_satellite_ai_evaluation/demo/README.md",
    "usecases/04_production_incidents/demo/README.md",
    "usecases/04_production_incidents/demo/events.csv",
    "usecases/05_sailing_wind_forecast/demo/README.md",
    "src/sprtz/py.typed",
